...
The SysIDE plugin works best with the skills and tools from [bulb engineering](https://github.com/kairibu/bulb) installed. [Pi](https://pi.dev) is lightweight and saves context and tools and skills are kept simple to support on-prem, local AI models. This frontend and the skills and tools have been tested with Qwen3.6 and gpt-oss-120.
